...
const Sidebar = ({ data, onSort, onReset, handleChange, onOpen }) => {
  return (
    <div id='sidebar' className="sidebar">
        <input id='searchbar' type="search" name="batteryId" placeholder="Search" onChange={handleChange}></input>
        <div className="sortbox-buttons">
            ...
            <button className="sort-button" onClick={() => onSort(0)}>abc...</button>
        </div>
        <ItemList data={data} onOpen={onOpen} />
    </div>
  )
}
